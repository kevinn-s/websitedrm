                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                <th scope="col" class="px-4 py-3 w-[100px]">NIM</th>
                                <th scope="col" class="px-4 py-3 w-[150px]">Nama Lengkap</th>
                                <th scope="col" class="px-4 py-3">Email</th>
                                <th scope="col" class="px-4 py-3 w-[175px]">Tanggal Registrasi</th>
                                <th scope="col" class="px-4 py-3 w-[100px]">Status</th>
                                <th scope="col" class="px-4 py-3 w-[165px]">Alumni Terdaftar</th>
                        ...
                        <tbody>
                            @forelse ($alumni as $a)
                                <tr class="border-b">
                                    ...
                                    <td class="px-4 py-3 font-bold text-gray-900 uppercase">{{ $a->onOfficialAlumni ? 'Terdaftar' : 'Tidak Terdaftar'}}</td>
                                    <td class="px-4 py-3 flex items-center gap-2 w-32">
                                        ...
                                        <div class="w-[40px] h-8 flex items-center">
                                            <x-admin.status-confirmation-modal :alumni="$a"></x-admin.status-confirmation-modal>
