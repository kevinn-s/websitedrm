        ...
        <div class="pb-4 border-b border-gray-200 w-full">
            <div class="flex flex-col items-center text-primary-grey">
                <img class="rounded-full w-28 h-28 mb-4" 
                     src="{{ $alumni->profile_photo_path ?? url('images/placeholder.png') }}"
            ...
            <div class="flex w-full justify-center">
                @can('update', $alumni)
                            <button
                                ...
                                <a href="{{ route('alumni.profile.edit', ['alumni' => $alumni->id]) }}">Edit Profile</a>
                            </button>
                @endcan
            </div>
        </div>
