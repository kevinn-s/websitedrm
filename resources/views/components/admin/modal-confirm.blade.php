    ...
    <div class="fixed inset-0 bg-gray-900/50 z-50 transition-opacity" x-show="confirmOpen"
    ...
    <div id="confirm-modal" class="fixed inset-0 z-50 overflow-hidden flex items-center justify-center px-4 sm:px-6"
        role="dialog" aria-modal="true" x-show="confirmOpen" x-transition:enter="transition ease-in-out duration-200"
        ...
        <div class="bg-white border border-transparent overflow-hidden max-w-lg w-full rounded-xl shadow-2xl relative z-10"
            ...
            <!-- Content -->
            <div class="px-6 py-6">
                <p class="text-lg font-medium text-gray-900">Apakah anda yakin untuk melakukan proses ini?</p>
            </div>
